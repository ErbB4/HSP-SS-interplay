...
# growth curves
gc_axon  = {'growth_curve': growth_curve_d, 'z': z0_mean, 'growth_rate': growth_factor[i]*slope*target_rate, 'eps': target_rate, 'continuous': False}
gc_den = {'growth_curve': growth_curve_a, 'z': z0_mean, 'growth_rate': growth_factor[i]*slope*target_rate, 'eps': target_rate,'continuous': False}
