...
# saving location
T = "/work/ws/nemo/fr_hl1029-gaussian-0/"
...
trains_time_points_final = np.linspace(1000.,(i+1)*growth_time+1000.,int((i+1)*growth_time/1000.)+1)

trains_amplitude_final = np.linspace(500.,0.,int((i+1)*growth_time/1000.)+1)
