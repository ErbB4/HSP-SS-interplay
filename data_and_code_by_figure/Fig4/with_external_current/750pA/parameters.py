...
trains_time_points_final = np.linspace(1000.,4*growth_time+1000.,int(4*growth_time/1000.)+1)

trains_amplitude_final = np.linspace(750.,0.,int(4*growth_time/1000.)+1)
