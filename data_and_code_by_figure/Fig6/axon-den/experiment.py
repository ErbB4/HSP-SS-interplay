...
i = int(sys.argv[1])
eta_axon = [0.00001,0.0001, 0.0004, 0.0007, 0.001, 0.005]
#save rank for MPI
rank = nest.Rank()
...
# growth curves
gc_axon  = {'growth_curve': growth_curve_d, 'z': z0_mean, 'growth_rate': 0.1*slope*target_rate, 'eps': target_rate, 'eta':eta_axon[i],'continuous': False}
gc_den = {'growth_curve': growth_curve_a, 'z': z0_mean, 'growth_rate': 0.1*slope*target_rate, 'eps': target_rate, 'eta':0.0007,'continuous': False}
...
nest.SetStatus(poisson_generator_sub, {"rate": 0.*rate})
