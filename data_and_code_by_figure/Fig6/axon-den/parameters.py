...
# saving location
T = "/work/ws/nemo/fr_hl1029-axonden-0/"
...
total_num_virtual_procs = 40#100                       # number = nodes * ppn in experiment.moab
growth_time             = 6000000.                   # simulation time in ms
cicles                  = 20
growth_step             = growth_time/cicles
mini_step             = growth_step/30
min_delay               = 1.0
max_delay               = 1.5
...
IE_time = 1000000.
trains_time_points_final = np.linspace(1000.,4*IE_time+1000.,int(4*IE_time/1000.)+1)

trains_amplitude_final = np.linspace(750.,0.,int(4*IE_time/1000.)+1)
